"""dmd dmd
입체사목과 유사한, 타일을 떨어뜨려 4개를 한 줄로 늘어놓는 게임"""

import sys
# 말판을 표시하기 위해 사용되는 상수
EMPTY_SPACE = '.'  # 마침표가 공백보다 춸씬 더 세기 편하다
PLAYER_X = 'X'
PLAYER_O = 'O'
...
def main():
    ...
    print(
        '''
        두 사람이 차례로 7개 열 중 하나에 타일을 떨어뜨려 수평, 수직, 대각선으로 사목을 만든다.
        '''
    )
...
def isWinner(playerTile, board):
    ...
    for columnIndex in range(BOARD_WIDTH - 3):
        for rowIndex in range(BOARD_HEIGHT - 3):
            ...
            tile3 = board[(columnIndex + 3, rowIndex + 2)]
            tile4 = board[(columnIndex, rowIndex + 3)]
            if tile1 == tile2 == tile3 == tile4 == playerTile:
                return True
    return False
