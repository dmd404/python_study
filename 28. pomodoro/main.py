...
import math
# ---------------------------- CONSTANTS ------------------------------- #
# check colorhunt.co for more colors
PINK = "#e2979c"
RED = "#e7305b"
GREEN = "#9bdeac"
YELLOW = "#f7f5dd"
...
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)  # roughly same size as the image and to work with even number
